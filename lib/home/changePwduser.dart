...
class changePwdUser extends StatefulWidget {
  const changePwdUser({ Key? key }) : super(key: key);

  @override
  _changePwdUserState createState() => _changePwdUserState();
}

class _changePwdUserState extends State<changePwdUser> {
  late String? id;
  //late String? _nom;
  //late String? _prenom;
  late String? _email;
