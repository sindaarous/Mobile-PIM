...
import 'package:workshop_sim4/acceuiluser.dart';
...
void main() => runApp(const HomeUser());
...
class _HomeUserState extends State<HomeUser> {
   int currentTab = 0;
  final List<Widget> screens = [ BodyTous(), HomeUser()];

  final PageStorageBucket bucket = PageStorageBucket();
  Widget currentScreen = AccueilUser();
  late String? _email;
